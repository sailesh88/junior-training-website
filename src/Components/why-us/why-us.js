            ...
            <div className="twelve columns collapsed">
              <div className="bgrid-quarters s-bgrid-thirds cf">
                <ol>
                  ...
                  <li> No school like approach </li><p>You will receive minimal guidance. Instead, you will learn by shadowing senior QA engineers and by working on real problems.</p>
