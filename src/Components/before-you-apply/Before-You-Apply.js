          ...
          <div className="row">
            ...
            <div className="twelve columns collapsed">
              <div className="bgrid-quarters s-bgrid-thirds cf">
                ...
                <ol>
                  <li> Fully remote </li><p>This training program will be fully remote. It takes a lot of discipline and motivation to sit at home for 9 hours/day and 5 days/week.</p>
                  <li> Self-starters </li><p>The training methodology is geared towards self-starters. So we only accept trainees who have done demoable projects out of their own interest.</p>
